...
pdfParser.on('pdfParser_dataReady', pdfData => {
    ...
    for (let i = 0; i < rawLines.length; i++) {
      ...
      if (lineText.includes('Spesifikasi :')) {
          ...
          if (extractedUraian.includes('DALAM NEGERI PERGI PULANG') || extractedUraian.includes('UANG HARIAN PERJALANAN DINAS LUAR')) {
              console.log('\n========================');
