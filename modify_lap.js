const fs = require('fs');
let code = fs.readFileSync('src/app/laporan/LaporanPerbandingan.tsx', 'utf8');
...
`;
    // We want to replace the LAST </tr> inside selectedPaket.rincian.map
    // It looks like:
    ...
    fs.writeFileSync('src/app/laporan/LaporanPerbandingan.tsx', code);
    console.log("Updated LaporanPerbandingan");
} else {
